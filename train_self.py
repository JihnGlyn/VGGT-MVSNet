...
import argparse, os, sys, time, gc, datetime, random
    ...
    for epoch_idx in range(start_epoch, args.epochs):
        ...
        for batch_idx, sample in enumerate(TrainImgLoader):
            ...
            if do_summary:
                ...
                print(
                    "Epoch:{}/{}, Iter:{}/{}, lr:{:.6f}, train loss:{:.3f}, recon loss:{:.3f}, ssim loss:{:.3f}, smooth loss:{:.3f}, photo loss:{:.3f}, feature loss:{:.3f}, time:{:.3f}".format(
                        ...
                        scalar_outputs['photometric_loss'],
                        scalar_outputs['featuremetric_loss'],
...
def train_sample(model, model_loss, optimizer, sample, args):
    ...
    try:
        ...
        loss, recon_loss, ssim_loss, \
            smooth_loss, photo_loss, feature_loss = model_loss(outputs, sample_cuda["imgs"],
    ...
    scalar_outputs = {"loss": loss,
                      ...
                      "featuremetric_loss": feature_loss,
                      }
